...
Twoje zamówienie o numerze {{ $order->id }} zostało potwierdzone i przeszło w proces realizacji.
W przeciągu kilku dni paczka powinna zostać dostarczona. W razie problemów kontaktuj się z naszym działem klienta
(jednak nie, bo ze względu na problemy budżetowe dział klienta jeszcze nie istnieje).
