...
Twoje zamówienie o numerze {{ $order->id }} zostało anulowane. Jak Cię to tak boli to możesz pisać do nieistniejącego działu klienta B)

Oto dane Twojego zamówienia (tego z numerem {{ $order->id }}), które już nigdy nie zostanie zrealizowane
